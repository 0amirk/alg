...
export default function Downloads() {
  return (
    <div className="min-h-screen  bg-[#161a1e] ">
      ...
      <div className="container px-4 mx-auto md:pt-36 sm:px-12 md:px-20 lg:px-28">
        <div className="grid grid-cols-1 gap-6 mb-12 md:grid-cols-2">
          ...
          <div className="bg-[#9c89d1] p-6 rounded-lg">
            <h2 className="mb-4 text-2xl font-bold">General Instructions</h2>
            <p className="text-white">
              <strong>Make Bootable USB:</strong>
            </p>
        ...
        <div className="grid grid-cols-1 gap-6 mb-12 md:grid-cols-40-60">
          <div className="flex flex-col justify-center p-6 rounded-lg">
            <h2 className="mb-4 text-6xl font-bold text-white">KDE Plasma</h2>
            <p className="mb-4 text-lg leading-relaxed text-gray-400">
              The Plasma Themed Edition (also known as the Flagship) of Arch
              Linux GUI helps you install Vanilla Arch Linux with the KDE Plasma
              Desktop Environment. It is pre-configured and ready to use. It
              comes with all the necessary software and settings to help users
              get started quickly.
            </p>
        ...
        <div className="grid grid-cols-1 gap-6 mb-12 md:grid-cols-60-40">
          ...
          <div className="flex flex-col justify-center p-6 rounded-lg">
            <h2 className="mb-4 text-6xl font-bold text-white">GNOME</h2>
            <p className="mb-4 text-lg leading-relaxed text-gray-400">
              ...
              ready to use. It comes with all the necessary software and
        ...
        <div className="grid grid-cols-1 gap-6 mb-12 md:grid-cols-40-60">
          <div className="flex flex-col justify-center p-6 rounded-lg">
            <h2 className="mb-4 text-6xl font-bold text-white">XFCE</h2>
            <p className="mb-4 text-lg leading-relaxed text-gray-400">
